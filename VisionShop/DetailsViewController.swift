...
import AVFoundation
var itemNameForDetail: String!
var itemPriceForDetail: String!
...
class detailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        itemName.text = itemNameForDetail
        itemPrice.text = "$\(itemPriceForDetail!)"
        
        
        let fileManager = FileManager.default
        let imagePAth = (self.getDirectoryPath() as NSString).appendingPathComponent(itemImage[selectedIndexPathRow])
